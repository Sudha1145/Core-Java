class CountryRunner
{
	public static void main(String[] args)
	{
		...
		Country1.primeMinisterBackward(primeMinisters);
		...
		Country1.cabinetMinisterBakward(cabinetMinisters);
		...
		Country1.politicalPartieBackward(politicalParties);
